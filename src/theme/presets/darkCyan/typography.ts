import { ui } from "@/theme/core/ui";

import { darkCyanGradients } from "./gradients";

export const darkCyanTypography = {
  display: {
    base: `
      font-display
      font-medium
    ...
    variants: {
      primary: darkCyanGradients.display.primary,

      secondary: darkCyanGradients.display.secondary,

      tertiary: darkCyanGradients.display.tertiary,
    },
  },
